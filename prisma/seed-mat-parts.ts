...
requireDestructiveSeedOptIn("seed-mat-parts.ts");

const prisma = new PrismaClient();

const SECTION_SLUG = "mat-certification";
...
const parts: Array<{
  ...
  {
    title: "The balance approach to mat teaching",
    type: PartType.VIDEO,
    body: "<p><em>Written content coming soon.</em></p>",
    videoUrl: null as unknown as string,
  },
  {
    title: "Class structure and programming",
    type: PartType.TEXT,
    body: "<p><em>Content coming soon.</em></p>",
  },
  {
    title: "Cueing on the mat",
    type: PartType.VIDEO,
    body: "<p><em>Written content coming soon.</em></p>",
    videoUrl: null as unknown as string,
  },
  {
    title: "Exercise library — video demonstrations",
    type: PartType.VIDEO,
    body: "<p><em>Written content coming soon.</em></p>",
    videoUrl: null as unknown as string,
  },
  {
    title: "Programming assignment brief",
    type: PartType.SUBMIT,
    body: "<p><em>Brief and submission instructions coming soon.</em></p>",
  },
  {
    title: "Additional reading — Unit 3 workbook",
    type: PartType.DOWNLOAD,
    fileUrl: null as unknown as string,
  },
  {
    title: "Mat practical assessment information",
    type: PartType.VIDEO,
    body: "<p><em>Written content coming soon.</em></p>",
    videoUrl: null as unknown as string,
  },
